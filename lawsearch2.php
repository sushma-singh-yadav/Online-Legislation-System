...
<div id="right">
	...
	<h1 style="margin-left: 150px;"> LAW Search </h1> <br><br>

	<label style="font-size: 20px;">LAW Name: </label>
	<input type="text" style="height: 40px; width: 300px;" id="fname" placeholder="Write complete name of the Law" required autofocus><br><br>
